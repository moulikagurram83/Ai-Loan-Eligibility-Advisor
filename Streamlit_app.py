...
def footer():
    ...
    st.markdown("[LinkedIn](https://www.linkedin.com/in/moulika-gurram-174a11296")
    st.markdown("[GitHub](https://github.com/moulikagurram83)")
    st.markdown("📧 Email: moulikagurram04@gmail.com")
